...
public class ModelProveedores {
    ...
    public String updateSql(){
        String id = JOptionPane.showInputDialog("Dame la id del PROVEEDOR","");
        sql = "UPDATE proveedores SET nombre='"+nombre+"',rfc='"+rfc+"',calle='"+calle+"',no='"+no+"',colonia='"+colonia+"',ciudad='"+ciudad+"',estado='"+estado+"',nombre_contacto='"+contacto+"',telefono='"+telefono+"',email='"+email+"' WHERE id_proveedor='"+id+"'";
        return sql;
    }
}
